<!-- app\pages\(competitions)\standings\commander\index.vue -->
...
<template>
  <UDashboardPanel id="standings-commander">
    <template #header>
      <UDashboardNavbar :title="$t('standings.commanderBreadcrumb')" :ui="{ right: 'gap-2' }">
        <template #leading>
