...
<!--
  ...
  replaces a separate hand-duplicated skeleton. No selection/context-menu
  wiring here (locations has neither), so this stays a single file instead
  of splitting into its own Cover.vue.
-->
<script setup lang="ts">
import type { Location } from '~/types'

const { location = null, onEdit, loading = false } = defineProps<{
