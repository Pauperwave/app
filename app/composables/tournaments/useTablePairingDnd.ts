// app\composables\tournaments\useTablePairingDnd.ts
...
import type { PairingPlayer, PairingHistoryEntry, PairingScoreDetails } from '~/composables/tournaments/pairingOptimizer'
