...
// real players table (user_id) with its associate (name, email,
// pauperwave_associate_number, is_active). No mutations composable yet —
// /players is read-only for now (see docs/TODO.md).
