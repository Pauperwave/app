...
const associates: Associate[] = Array.from({ length: 250 }, (_, i) => {
  // Generate request_time in HH:MM format
  const requestTimeDate = faker.date.past()
  const request_time = requestTimeDate
  ...
  return {
    ...
    request_date: requestTimeDate.toLocaleDateString('it-IT'), // Format: DD/MM/YYYY
    request_time, // Format: HH:MM
