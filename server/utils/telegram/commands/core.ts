...
const HELP_TEXT = 'Comandi disponibili:\n\n'
  ...
  + '/iscrizioni — i tornei a cui sei iscritto\n\n'
  + '🏟️ Durante un torneo\n'
  + '🚧 /tavolo — tavolo e avversario del turno (in lavorazione, dati di esempio)\n'
  + '🚧 /vota — vota miglior mazzo/miglior giocata (in lavorazione, dati di esempio)\n'
  + '🚧 /risultato — posizione e uccisioni del tavolo (in lavorazione, dati di esempio)\n\n'
  + '👤 Account\n'
