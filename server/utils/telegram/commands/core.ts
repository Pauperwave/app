...
const HELP_TEXT = 'Comandi disponibili:\n\n'
  ...
  + '/cartecercate — carte cercate dai soci, con paginazione e gestione delle tue richieste\n'
  + '/tessera — stato del tuo tesseramento\n'
  + '/mazzi — i tuoi mazzi Commander\n'
  + '/visibilita — mostra/nascondi i tornei di negozi esterni (es. Magman) in /calendario\n\n'
  + 'In arrivo:\n'
  + '/notifiche\n\n'
