...
- **Building anything role/permission-aware (admin vs. player)?** `architecture/roles.md` first — what's actually live vs. only designed, and why client-side checks alone aren't security
