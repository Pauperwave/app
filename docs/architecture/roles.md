...
const PERMISSION_LEVEL = {
  ...
  'manage-roles': 'super_admin' // the one capability kept super_admin-only alongside permanent deletion — self-promotion risk
