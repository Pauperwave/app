...
| `/prossimo` | Pubblico | 🔴 | Scorciatoia rispetto a `/tornei`: solo il prossimo evento in ordine cronologico, nessun bottone. Rinominato da `/prossimotorneo` (troppo lungo, 2026-09-02). Comando registrato, risponde "🚧 da implementare" (`commands/stubs.ts`). |
