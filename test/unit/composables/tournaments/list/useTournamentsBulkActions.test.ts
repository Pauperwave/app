// test\unit\composables\tournaments\list\useTournamentsBulkActions.test.ts
import { afterEach, beforeEach, describe, expect, it, vi } from 'vitest'
import { useTournamentsBulkActions } from '~/composables/tournaments/list/useTournamentsBulkActions'
